...
import static com.ekumfi.agent.constants.keyConst.APP_HASH;
                                    ...
                                    if (response.has("user_not_found")) {
                                        ...
                                        Realm.getInstance(RealmUtility.getDefaultConfig(SigninActivity.this)).executeTransaction(realm -> {
                                            try {
                                                ...
                                                realm.createOrUpdateAllFromJson(RealmWholesaler.class, response.getJSONArray("agents"));
                                                ...
                                                realm.createOrUpdateAllFromJson(RealmWholesalerCart.class, response.getJSONArray("stock_carts"));
                                                realm.createOrUpdateAllFromJson(RealmChat.class, response.getJSONArray("ekumfi_chats"));

                                                PreferenceManager
                                                        .getDefaultSharedPreferences(getApplicationContext())
                                                        .edit()
                                                        .putString("com.ekumfi.agent" + APITOKEN, response.getString("api_token"))
                                                        .apply();
