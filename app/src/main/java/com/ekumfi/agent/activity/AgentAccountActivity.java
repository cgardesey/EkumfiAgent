...
import static com.ekumfi.agent.fragment.AgentAccountFragment1.last_name;
import static com.ekumfi.agent.fragment.AgentAccountFragment1.first_name;
import static com.ekumfi.agent.fragment.AgentAccountFragment1.other_names;
import static com.ekumfi.agent.fragment.AgentAccountFragment1.profile_image_file;
import static com.ekumfi.agent.fragment.AgentAccountFragment2.latitude;
import static com.ekumfi.agent.fragment.AgentAccountFragment2.longitude;
import static com.ekumfi.agent.fragment.AgentAccountFragment2.momo_number;
import static com.ekumfi.agent.fragment.AgentAccountFragment2.primary_contact;
import static com.ekumfi.agent.fragment.AgentAccountFragment3.identification_image_file;
import static com.ekumfi.agent.fragment.AgentAccountFragment1.profile_image;
import static com.ekumfi.agent.fragment.AgentAccountFragment3.identification_number;
import static com.ekumfi.agent.fragment.AgentAccountFragment3.identification_type_spinner;
...
import com.ekumfi.agent.fragment.AgentAccountFragment1;
import com.ekumfi.agent.fragment.AgentAccountFragment2;
import com.ekumfi.agent.fragment.AgentAccountFragment3;
import com.ekumfi.agent.other.MyHttpEntity;
import com.ekumfi.agent.pagerAdapter.AgentAccountPageAdapter;
...
public class AgentAccountActivity extends PermisoActivity {
    ...
    public static RealmWholesaler realmAgent = new RealmWholesaler();
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                if (profile_image_file != null) {
                    multipartEntityBuilder.addPart("shop_image_file", new FileBody(profile_image_file));
                }
                multipartEntityBuilder.addTextBody("first_name", first_name.getText().toString().trim());
                multipartEntityBuilder.addTextBody("other_names", other_names.getText().toString().trim());
                multipartEntityBuilder.addTextBody("last_name", last_name.getText().toString().trim());
...
//                multipartEntityBuilder.addTextBody("auxiliary_contact", auxiliary_contact.getText().toString());
                ...
                multipartEntityBuilder.addTextBody("user_id", PreferenceManager.getDefaultSharedPreferences(AgentAccountActivity.this).getString("com.ekumfi.agent" + MYUSERID, ""));
                ...
                if (result.contains("connect")) {
                    ...
                    try {
                        ...
                        Realm.getInstance(RealmUtility.getDefaultConfig(AgentAccountActivity.this)).executeTransaction(realm -> {
                            try {
                                realm.createOrUpdateObjectFromJson(RealmWholesaler.class, jsonObject.getJSONObject("agent"));
