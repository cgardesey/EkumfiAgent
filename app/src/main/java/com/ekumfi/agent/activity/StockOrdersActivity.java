...
import com.ekumfi.agent.pagerAdapter.StockOrdersPagerAdapter;
import com.ekumfi.agent.realm.RealmStockCart;
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(
                    ...
                    public Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("seller_id", PreferenceManager.getDefaultSharedPreferences(StockOrdersActivity.this).getString("com.ekumfi.agent" + "SELLER_ID", ""));
                        return params;
                    }
                    ...
                    public Map getHeaders() throws AuthFailureError {
                        ...
                        headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(StockOrdersActivity.this).getString("com.ekumfi.agent" + APITOKEN, ""));
                        return headers;
                    }
                };
        ...
        /*StringRequest stringRequest = new StringRequest(
            ...
            *//** Passing some request headers* *//*
            ...
            public Map getHeaders() throws AuthFailureError {
                HashMap headers = new HashMap();
                headers.put("accept", "application/json");
                headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(OrdersActivity.this).getString("com.ekumfi.agent" + APITOKEN, ""));
                return headers;
            }
        };
        stringRequest.setRetryPolicy(new DefaultRetryPolicy(
