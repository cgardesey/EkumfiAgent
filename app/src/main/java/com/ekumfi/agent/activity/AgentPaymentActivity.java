...
import com.ekumfi.agent.adapter.PaymentsAdapter;
...
//        menu = findViewById(R.id.menu);
    ...
    protected void onResume() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                Request.Method.GET,
                API_URL + "agent-payments",
                null,
                response -> {
                    if (response != null) {
                        Realm.init(getApplicationContext());
                        Realm.getInstance(RealmUtility.getDefaultConfig(AgentPaymentActivity.this)).executeTransaction(realm -> {
