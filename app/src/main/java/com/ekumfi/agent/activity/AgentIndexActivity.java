...
import com.ekumfi.agent.adapter.AgentIndexAdapter;
...
public class AgentIndexActivity extends PermisoActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        agentIndexAdapter = new AgentIndexAdapter(new AgentIndexAdapter.AgentIndexAdapterInterface() {
            ...
            @Override
            public void onItemClick(ArrayList<RealmWholesaler> realmAgents, int position, AgentIndexAdapter.ViewHolder holder) {

            }

            @Override
            public void onImageClick(ArrayList<RealmWholesaler> realmAgents, int position, AgentIndexAdapter.ViewHolder holder) {

            }
            @Override
            public void onMenuClick(ArrayList<RealmWholesaler> realmAgents, int position, AgentIndexAdapter.ViewHolder holder) {
                final RealmWholesaler[] realmAgent = {realmAgents.get(position)};
                    ...
                    if (item.getItemId() == R.id.edit) {
                        ...
                        StringRequest stringRequest = new StringRequest(
                            ...
                            public Map getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(AgentIndexActivity.this).getString(HomeActivity.APITOKEN, ""));
                                return headers;
                            }
                        };
...
//                                                    realm.where(RealmAgentProduct.class).findAll().deleteAllFromRealm();
                                ...
                                public Map getHeaders() throws AuthFailureError {
                                    HashMap headers = new HashMap();
                                    headers.put("accept", "application/json");
                                    headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(AgentIndexActivity.this).getString("com.ekumfi.agent" + APITOKEN, ""));
                                    return headers;
                                }
                                @Override
    ...
    public static void populateChatIndex(final Context context) {
        ...
        Realm.getInstance(RealmUtility.getDefaultConfig(context)).executeTransaction(realm -> {
            ...
            newCart.clear();
            for (RealmWholesaler realmAgent : results) {
