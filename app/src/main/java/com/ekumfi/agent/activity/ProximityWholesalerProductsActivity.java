...
import com.ekumfi.agent.adapter.ProximityWholesalerProductAdapter;
import com.ekumfi.agent.materialDialog.ChooseAgentQuantityMaterialDialog;
...
import com.ekumfi.agent.realm.RealmWholesalerProduct;
...
public class ProximityWholesalerProductsActivity extends PermisoActivity implements ChooseAgentQuantityMaterialDialog.ChooseAgentQuantityMDInterface {

    RecyclerView recyclerview;
    ProximityWholesalerProductAdapter proximityAgentProductAdapter;
    private ImageView cartIcon, backbtn;
    ArrayList<RealmWholesalerProduct> RealmWholesalerProducts = new ArrayList<>(), newRealmWholesalerProducts = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                viewStockCart(ProximityWholesalerProductsActivity.this, null);
            }
        });
        ...
        proximityAgentProductAdapter = new ProximityWholesalerProductAdapter(new ProximityWholesalerProductAdapter.ContactMethodAdapterInterface() {
            @Override
            public void onListItemClick(ArrayList<RealmWholesalerProduct> RealmWholesalerProducts, int position, ProximityWholesalerProductAdapter.ViewHolder holder) {
                ...
                if (chooseServiceContactMethodMaterialDialog != null && chooseServiceContactMethodMaterialDialog.isAdded()) {
                    ...
                    chooseServiceContactMethodMaterialDialog.setWholesaler_id(RealmWholesalerProduct.getWholesaler_id());
                ...
                new ProximityWholesalerProductAdapter.AddToCartAdapterInterface() {
                    @Override
                    public void onListItemClick(ArrayList<RealmWholesalerProduct> names, int position, ProximityWholesalerProductAdapter.ViewHolder holder) {
                        RealmWholesalerProduct RealmWholesalerProduct = RealmWholesalerProducts.get(position);
                        if (RealmWholesalerProduct.getQuantity_available() <= RealmWholesalerProduct.getUnit_quantity()) {
                            ...
                            if (chooseAgentQuantityMaterialDialog != null && chooseAgentQuantityMaterialDialog.isAdded()) {
                                ...
                                chooseAgentQuantityMaterialDialog.setAgent_id(RealmWholesalerProduct.getWholesaler_id());
                                chooseAgentQuantityMaterialDialog.setAgent_product_id(RealmWholesalerProduct.getWholesaler_product_id());
                                chooseAgentQuantityMaterialDialog.setQuantity_available(RealmWholesalerProduct.getQuantity_available());
                                chooseAgentQuantityMaterialDialog.setUnit_quantity(RealmWholesalerProduct.getUnit_quantity());
                                chooseAgentQuantityMaterialDialog.setUnit_price(RealmWholesalerProduct.getUnit_price());
                                chooseAgentQuantityMaterialDialog.setImage_url(RealmWholesalerProduct.getProduct_image_url());
                ...
                new ProximityWholesalerProductAdapter.LocationClickInterface() {
                    @Override
                    public void onListItemClick(ArrayList<RealmWholesalerProduct> names, int position, ProximityWholesalerProductAdapter.ViewHolder holder) {
                        Permiso.getInstance().requestPermissions(new Permiso.IOnPermissionResult() {
                                                                     ...
                                                                     public void onPermissionResult(Permiso.ResultSet resultSet) {
                                                                         if (resultSet.isPermissionGranted(Manifest.permission.ACCESS_COARSE_LOCATION) && resultSet.isPermissionGranted(Manifest.permission.ACCESS_FINE_LOCATION)) {
                                                                             RealmWholesalerProduct RealmWholesalerProduct = names.get(position);
                                                                             Uri gmmIntentUri = Uri.parse("geo:" + RealmWholesalerProduct.getLatitude() + "," + RealmWholesalerProduct.getLongitude());
                ...
                },productActivity, RealmWholesalerProducts);
...
//        recyclerview.setLayoutManager(new GridLayoutManager(getApplicationContext(), 2));
    ...
    public static void viewStockCart(Context context, JSONObject jsonObject) {
        ...
        StringRequest stringRequest = new StringRequest(
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            if (jsonArray.length() > 0) {
                                ...
                                context.startActivity(new Intent(context, WholesalerCartListActivity.class));
                            } else {
            ...
            public Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<>();
                params.put("seller_id", PreferenceManager.getDefaultSharedPreferences(context).getString("com.ekumfi.agent" + "SELLER_ID", ""));
                return params;
            }
            /** Passing some request headers* */
            @Override
    ...
    void populateProducts(final Context context) {
        newRealmWholesalerProducts.clear();

        Realm.init(context);
        Realm.getInstance(RealmUtility.getDefaultConfig(context)).executeTransaction(realm -> {
            String stringExtra;
            String fieldName;
            RealmResults<RealmWholesalerProduct> RealmWholesalerProducts = realm.where(RealmWholesalerProduct.class)
                    .findAll();


            for (RealmWholesalerProduct RealmWholesalerProduct : RealmWholesalerProducts) {
                newRealmWholesalerProducts.add(RealmWholesalerProduct);
            }

            this.RealmWholesalerProducts.clear();
            this.RealmWholesalerProducts.addAll(newRealmWholesalerProducts);
    ...
    public void onStockCartViewClick(String message, JSONObject jsonObject) {
        ...
        textViewOne.setOnClickListener(v -> {
            viewStockCart(ProximityWholesalerProductsActivity.this, jsonObject);
        });
        ...
        textViewTwo.setOnClickListener(v -> {
            order(ProximityWholesalerProductsActivity.this, jsonObject);
        });
