...
import static com.ekumfi.agent.activity.GetSellerAuthActivity.getSellerAuthActivity;
import static com.ekumfi.agent.activity.GetSellerPhoneNumberActivity.getSellerPhoneNumberActivity;
...
import static com.ekumfi.agent.fragment.SellerAccountFragment1.seller_type_spinner;
import static com.ekumfi.agent.fragment.SellerAccountFragment1.shop_image_file;
import static com.ekumfi.agent.fragment.SellerAccountFragment1.shop_name;
import static com.ekumfi.agent.fragment.SellerAccountFragment2.latitude;
import static com.ekumfi.agent.fragment.SellerAccountFragment2.longitude;
import static com.ekumfi.agent.fragment.SellerAccountFragment2.momo_number;
import static com.ekumfi.agent.fragment.SellerAccountFragment2.primary_contact;
import static com.ekumfi.agent.fragment.SellerAccountFragment3.identification_image_file;
import static com.ekumfi.agent.fragment.SellerAccountFragment3.identification_number;
import static com.ekumfi.agent.fragment.SellerAccountFragment3.identification_type_spinner;
...
import com.ekumfi.agent.fragment.SellerAccountFragment1;
import com.ekumfi.agent.fragment.SellerAccountFragment2;
import com.ekumfi.agent.fragment.SellerAccountFragment3;
import com.ekumfi.agent.other.MyHttpEntity;
import com.ekumfi.agent.pagerAdapter.SellerAccountPageAdapter;
...
//                multipartEntityBuilder.addTextBody("auxiliary_contact", auxiliary_contact.getText().toString());
                ...
                Realm.init(getApplicationContext());
                final String agent_id = Realm.getInstance(RealmUtility.getDefaultConfig(getApplicationContext())).where(RealmWholesaler.class).findFirst().getAgent_id();
                multipartEntityBuilder.addTextBody("agent_id", agent_id);
