...
import com.ekumfi.agent.adapter.StockCartItemAdapter;
...
public class WholesalerCartItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stockCartItemAdapter = new StockCartItemAdapter(new StockCartItemAdapter.StockCartItemAdapterInterface() {
            ...
            public void onRemoveClick(ArrayList<RealmStockCartProduct> realmStockCartProducts, int position, StockCartItemAdapter.ViewHolder holder) {
                ...
                StringRequest stringRequest = new StringRequest(
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    if (jsonObject.getBoolean("status")) {
                                        ...
                                        Realm.getInstance(RealmUtility.getDefaultConfig(WholesalerCartItemsActivity.this)).executeTransaction(realm -> {
                                        ...
                                        Toast.makeText(WholesalerCartItemsActivity.this, "Successfully deleted.", Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(WholesalerCartItemsActivity.this, "Error deleting.", Toast.LENGTH_SHORT).show();
                                    }
                        ...
                        error -> {
                            ...
                            Const.myVolleyError(WholesalerCartItemsActivity.this, error);
            ...
            public void onQuantityUpdateClick(ArrayList<RealmStockCartProduct> realmStockCartProducts, int position, StockCartItemAdapter.ViewHolder holder) {
                ...
                ProgressDialog mProgress = new ProgressDialog(WholesalerCartItemsActivity.this);
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    Realm.getInstance(RealmUtility.getDefaultConfig(getApplicationContext())).executeTransaction(realm -> {
                                        ...
                                        WholesalerCartItemsActivity.this.totalamt += updatedprice;

                                    });
                                    Toast.makeText(WholesalerCartItemsActivity.this, "Quantity successfully updated.", Toast.LENGTH_SHORT).show();
                                    total.setText("GHC" + String.format("%.2f", totalamt));
        ...
        }, WholesalerCartItemsActivity.this, cartItemsArrayList);
