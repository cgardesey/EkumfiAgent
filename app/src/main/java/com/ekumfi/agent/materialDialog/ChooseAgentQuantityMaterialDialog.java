    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RealmSeller realmSeller = Realm.getInstance(RealmUtility.getDefaultConfig(getContext())).where(RealmSeller.class).equalTo("seller_id", PreferenceManager.getDefaultSharedPreferences(getContext()).getString("com.ekumfi.agent" + "SELLER_ID", "")).findFirst();
