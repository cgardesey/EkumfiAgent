package com.ekumfi.agent.other;
...
//        TimeZone.setDefault(TimeZone.getTimeZone("GMT"));
        ...
        this.isNightModeEnabled = mPrefs.getBoolean("com.ekumfi.agent" + NIGHT_MODE, false);
    }
    ...
    public void setIsNightModeEnabled(boolean isNightModeEnabled) {
        ...
        editor.putBoolean("com.ekumfi.agent" + NIGHT_MODE, isNightModeEnabled);
        editor.apply();
    }
