...
import static com.ekumfi.agent.activity.HomeActivity.APITOKEN;
...
import com.ekumfi.agent.adapter.BannersAdapter;
    ...
    private class uploadBannersAsync extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                httpPost.setHeader("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("com.ekumfi.agent" + APITOKEN, ""));
