...
import com.ekumfi.agent.activity.ChooseSellerIndexActivity;
import com.ekumfi.agent.adapter.ChatIndexAdapter;
...
public class ChatIndexFragment extends Fragment {
    ...
    public void onResume() {
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                API_URL + "scoped-latest-agent-chats",
                response -> {
                    if (response != null) {
                        try {
