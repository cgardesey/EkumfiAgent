...
import static com.ekumfi.agent.materialDialog.ProductMaterialDialog.controls;
import static com.ekumfi.agent.materialDialog.ProductMaterialDialog.product_image;
import static com.ekumfi.agent.materialDialog.ProductMaterialDialog.image_not_set;
import static com.ekumfi.agent.materialDialog.ProductMaterialDialog.product_image_file;
...
import com.ekumfi.agent.adapter.ProductAdapter;
import com.ekumfi.agent.constants.Const;
import com.ekumfi.agent.materialDialog.ProductMaterialDialog;
                    ...
                    if (itemId == R.id.edit) {
                        ...
                        StringRequest stringRequestDelete = new StringRequest(
                            ...
                            public Map getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "Bearer " + PreferenceManager.getDefaultSharedPreferences(mContext).getString("com.ekumfi.agent" + APITOKEN, ""));
                                return headers;
                            }
