...
import static com.ekumfi.agent.util.Constants.CMD_CREATE_TABLE_INE;
import static com.ekumfi.agent.util.Constants.COMMA;
import static com.ekumfi.agent.util.Constants.LBR;
import static com.ekumfi.agent.util.Constants.RBR;
import static com.ekumfi.agent.util.Constants.SEMI;
import static com.ekumfi.agent.util.Constants.TYPE_BLOB;
import static com.ekumfi.agent.util.Constants.TYPE_INT;
import static com.ekumfi.agent.util.Constants.TYPE_PK_AI;
import static com.ekumfi.agent.util.Constants.TYPE_TEXT;
