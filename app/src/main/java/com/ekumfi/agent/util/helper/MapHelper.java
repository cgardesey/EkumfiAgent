package com.ekumfi.agent.util.helper;


import static com.ekumfi.agent.util.helper.MapTypes.NONE;
import static com.ekumfi.agent.util.helper.MarkerColors.AZURE;
import static com.ekumfi.agent.util.helper.MarkerColors.BLUE;
import static com.ekumfi.agent.util.helper.MarkerColors.CYAN;
import static com.ekumfi.agent.util.helper.MarkerColors.GREEN;
import static com.ekumfi.agent.util.helper.MarkerColors.MAGENTA;
import static com.ekumfi.agent.util.helper.MarkerColors.ORANGE;
import static com.ekumfi.agent.util.helper.MarkerColors.RED;
import static com.ekumfi.agent.util.helper.MarkerColors.ROSE;
import static com.ekumfi.agent.util.helper.MarkerColors.VIOLET;
import static com.ekumfi.agent.util.helper.MarkerColors.YELLOW;
